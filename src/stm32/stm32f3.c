...
static void stm32f3_alternative_remap(uint32_t mapr_mask, uint32_t mapr_value)
{
...
gpio_peripheral(uint32_t gpio, uint32_t mode, int pullup)
{
    ...
    if (func == 1) {
        ...
        if (gpio == GPIO('B', 4) || gpio == GPIO('B', 5))
            ...
            stm32f3_alternative_remap(AFIO_MAPR_TIM4_REMAP_Msk,
        ...
        if (gpio == GPIO('B', 3) || gpio == GPIO('B', 4)
            || gpio == GPIO('B', 5))
            stm32f3_alternative_remap(AFIO_MAPR_SPI1_REMAP_Msk,
        ...
        if (gpio == GPIO('B', 6) || gpio == GPIO('B', 7))
            ...
            stm32f3_alternative_remap(AFIO_MAPR_USART2_REMAP_Msk,
                                      AFIO_MAPR_USART2_REMAP);
        else if (gpio == GPIO('D', 8) || gpio == GPIO('D', 9))
            stm32f3_alternative_remap(AFIO_MAPR_USART3_REMAP_Msk,
                                      AFIO_MAPR_USART3_REMAP_FULLREMAP);
    } else if (func == 9) {
        // CAN
        if (gpio == GPIO('B', 8) || gpio == GPIO('B', 9))
            stm32f3_alternative_remap(AFIO_MAPR_CAN_REMAP_Msk,
